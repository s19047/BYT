...
public class Money implements Comparable {
	...
	public String toString() {
		return String.format("%.2f %s",this.getAmount(),currency.getName());
	}
	 ...
	 * @param obj The other Money that is being compared to this Money.
	...
	public Money add(Money other) {
		return new Money(amount + currency.valueInThisCurrency(other), currency) ;
	}
